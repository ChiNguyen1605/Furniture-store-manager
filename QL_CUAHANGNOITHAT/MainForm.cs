...
namespace QL_CUAHANGNOITHAT
{
    public partial class MainForm : Form
    {
        ...
        private void MainPN_load()
        {
            switch (MainPN_ID)
            {
                ...
                case 6:
                    {
                        MainPN.Controls.Clear();
                        Control NhaCungCap_6 = new GUINhaCC(UserAccount);
                ...
                case 7:
                    {
                        MainPN.Controls.Clear();
                        Control KhuyenMai_7 = new GUIKhuyenMai(UserAccount);
                        MainPN.Controls.Add(KhuyenMai_7);
                    }
                    break;
                default:
                    break;
        ...
        {
            MainPN_ID = IDMainPN.IDKhuyenMai;
            MainPN_load();
        }
    }
}
