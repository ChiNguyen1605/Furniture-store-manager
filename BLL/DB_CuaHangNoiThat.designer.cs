...
namespace BLL
{
    ...
    partial void OnHinhAnhChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="NhomNguoiDung_KhachHang1", Storage="_NhomNguoiDung1", ThisKey="MaNhom", OtherKey="MaNhom", IsForeignKey=true)]
    ...
    partial void OnGiamGiaPhanTramChanging(decimal value);
    ...
    partial void OnApDungToanBoChanging(bool value);
    partial void OnApDungToanBoChanged();
    partial void OnMaLoaiChanging(System.Nullable<int> value);
    partial void OnMaLoaiChanged();
    partial void OnMaNhomChanging(string value);
    partial void OnMaNhomChanged();
    ...
    partial void OnTinhTrangChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_GiamGiaPhanTram", DbType="Decimal(5,2) NOT NULL")]
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_ApDungToanBo", DbType="Bit NOT NULL")]
		public bool ApDungToanBo
		{
			get
			{
				return this._ApDungToanBo;
			}
			set
			{
				if ((this._ApDungToanBo != value))
				{
					this.OnApDungToanBoChanging(value);
					this.SendPropertyChanging();
					this._ApDungToanBo = value;
					this.SendPropertyChanged("ApDungToanBo");
					this.OnApDungToanBoChanged();
				}
			}
		}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Loai_KhuyenMai", Storage="_Loai", ThisKey="MaLoai", OtherKey="MaLoai", IsForeignKey=true)]
		public Loai Loai
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="NhaCungCap_KhuyenMai", Storage="_NhaCungCap", ThisKey="MaNCC", OtherKey="MaNCC", IsForeignKey=true)]
		public NhaCungCap NhaCungCap
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="NhomNguoiDung_KhuyenMai", Storage="_NhomNguoiDung", ThisKey="MaNhom", OtherKey="MaNhom", IsForeignKey=true)]
		public NhomNguoiDung NhomNguoiDung
		{
			get
			{
    ...
    partial void OnTenLoaiChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Loai_KhuyenMai", Storage="_KhuyenMais", ThisKey="MaLoai", OtherKey="MaLoai")]
	...
	public partial class ManHinh : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<Quyen> _Quyens1;
    ...
    partial void OnTenMHChanged();
		...
		public ManHinh()
		{
			...
			this._Quyens1 = new EntitySet<Quyen>(new Action<Quyen>(this.attach_Quyens1), new Action<Quyen>(this.detach_Quyens1));
			OnCreated();
		}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="ManHinh_Quyen1", Storage="_Quyens1", ThisKey="MaMH", OtherKey="MaMH")]
		public EntitySet<Quyen> Quyens1
		{
			get
			{
				return this._Quyens1;
			}
			set
			{
				this._Quyens1.Assign(value);
			}
		}
		...
		private void attach_Quyens1(Quyen entity)
		{
			this.SendPropertyChanging();
			entity.ManHinh1 = this;
		}
		
		private void detach_Quyens1(Quyen entity)
		{
			this.SendPropertyChanging();
    ...
    partial void OnDiaChiChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="NhaCungCap_KhuyenMai", Storage="_KhuyenMais", ThisKey="MaNCC", OtherKey="MaNCC")]
		public EntitySet<KhuyenMai> KhuyenMais
		{
			get
			{
    ...
    partial void OnHinhAnhChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="NhomNguoiDung_NhanVien1", Storage="_NhomNguoiDung1", ThisKey="MaNhom", OtherKey="MaNhom", IsForeignKey=true)]
		public NhomNguoiDung NhomNguoiDung1
		{
			get
			{
    ...
    partial void OnTenNhomChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="NhomNguoiDung_KhachHang1", Storage="_KhachHangs1", ThisKey="MaNhom", OtherKey="MaNhom")]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="NhomNguoiDung_KhuyenMai", Storage="_KhuyenMais", ThisKey="MaNhom", OtherKey="MaNhom")]
		public EntitySet<KhuyenMai> KhuyenMais
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="NhomNguoiDung_NhanVien1", Storage="_NhanViens1", ThisKey="MaNhom", OtherKey="MaNhom")]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="NhomNguoiDung_Quyen1", Storage="_Quyens1", ThisKey="MaNhom", OtherKey="MaNhom")]
		public EntitySet<Quyen> Quyens1
		{
			get
			{
	...
	public partial class Quyen : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntityRef<ManHinh> _ManHinh1;
    ...
    partial void OnMaNhomChanged();
		...
		public Quyen()
		{
			...
			this._ManHinh1 = default(EntityRef<ManHinh>);
			this._NhomNguoiDung = default(EntityRef<NhomNguoiDung>);
			this._NhomNguoiDung1 = default(EntityRef<NhomNguoiDung>);
			OnCreated();
		}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="ManHinh_Quyen1", Storage="_ManHinh1", ThisKey="MaMH", OtherKey="MaMH", IsForeignKey=true)]
		public ManHinh ManHinh1
		{
			get
			{
			...
			set
			{
				ManHinh previousValue = this._ManHinh1.Entity;
				if (((previousValue != value) 
							|| (this._ManHinh1.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((previousValue != null))
					{
						...
						previousValue.Quyens1.Remove(this);
					}
					this._ManHinh1.Entity = value;
					if ((value != null))
					{
						value.Quyens1.Add(this);
						this._MaMH = value.MaMH;
					}
					else
					{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="NhomNguoiDung_Quyen1", Storage="_NhomNguoiDung1", ThisKey="MaNhom", OtherKey="MaNhom", IsForeignKey=true)]
		public NhomNguoiDung NhomNguoiDung1
		{
			get
			{
